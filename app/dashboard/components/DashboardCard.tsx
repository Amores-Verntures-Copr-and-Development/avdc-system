  ...
  return (
    <div className="flex flex-col justify-between p-3 xs:p-4 sm:p-5 border rounded-xl sm:rounded-2xl shadow-sm border-gray-200 bg-white hover:shadow-md transition-all duration-300 hover:scale-[1.02]">
      ...
      <div className="flex items-center gap-2 xs:gap-3 sm:gap-4">
        <div
          className={`${bgColor} p-2 xs:p-2.5 sm:p-3 rounded-lg sm:rounded-xl flex items-center justify-center flex-shrink-0`}
        >
          <Icon className="text-white w-4 h-4 xs:w-5 xs:h-5 sm:w-5 sm:h-5 md:w-6 md:h-6 lg:w-7 lg:h-7" />
        </div>
