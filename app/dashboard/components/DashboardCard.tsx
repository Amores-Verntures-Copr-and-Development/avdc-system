...
const DashboardCard = ({
  ...
  return (
    <div className="flex flex-col justify-between p-3 xs:p-4 sm:p-5 border rounded-xl sm:rounded-2xl shadow-sm border-gray-200 bg-white hover:shadow-md transition-all duration-300 hover:scale-[1.02]">
      {/* Top Section */}
      <div className="flex flex-row items-center gap-2 xs:gap-3 sm:gap-4">
        <div
        ...
        <div className="flex flex-col items-start min-w-0 flex-1">
          ...
          <span className="text-[10px] xs:text-sm sm:text-xs md:text-sm lg:text-base text-gray-500 truncate w-full mt-0.5 xs:mt-1">
            {title}
          </span>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between text-gray-600 hover:text-gray-900 cursor-pointer group">
        <span className="text-[10px] xs:text-sm sm:text-xs md:text-sm lg:text-sm font-medium truncate">
          View details
        </span>
