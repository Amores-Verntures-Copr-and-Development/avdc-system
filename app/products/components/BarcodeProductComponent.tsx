...
import { Camera, CameraOff, RefreshCcw, ScanLine, Trash } from "lucide-react";
...
interface BarcodeProductComponentProps {
...
const BarcodeProductComponent = ({
  data,
  onCancel,
  mutate,
}: BarcodeProductComponentProps) => {
  ...
  >(data ? `/api/barcode/prodVarId/${data.prodVarId}` : null, fetcher);
  ...
  const handleSaveBarcode = async () => {
    ...
    try {
      ...
      const res = await fetch(
        `/api/barcode/prodVarId/${barcodeData.prodVarId}`,
        {
          method: "POST",
          headers: {
...
export default BarcodeProductComponent;
