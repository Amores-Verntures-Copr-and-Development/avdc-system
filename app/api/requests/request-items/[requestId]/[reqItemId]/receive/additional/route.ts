...
import { AdditionalReceiveController } from "@/controllers/RequestController";
...
export async function POST(
  ...
  try {
    ...
    const data = (await request.json()) as AdditionalReceiveDto;

    const res = await AdditionalReceiveController(data);
    if (!res.success) {
