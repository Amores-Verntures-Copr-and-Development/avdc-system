...
const ProductContent = ({
  ...
  return (
    <div className="flex-1 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 p-2 gap-4 overflow-y-auto auto-rows-max items-start bg-white border  border-gray-200">
      {data.map((prod, index) => (
        <ProductCard
          key={index}
          data={prod}
