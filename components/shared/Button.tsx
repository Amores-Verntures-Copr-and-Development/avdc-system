...
const sizeClasses: Record<ButtonSize, string> = {
  xs: "text-[8px] lg:text-xs px-2 py-1",
  sm: "text-[9px] lg:text-xs lg:text-xs xl:text-xs px-1.5 py-1 xl:px-3 xl:py-1.5 ",
  md: "text-xs xl:text-sm 2xl:text-base px-4 py-2",
