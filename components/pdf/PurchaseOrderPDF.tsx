...
export const PurchaseOrderPDF = ({ data }: PurchaseOrderProps) => {
                ...
                <View style={styles.header}>
                  <View style={styles.titleContainer}>
                    ...
                    <Text style={{ fontSize: 10, color: "#666", marginTop: 2 }}>
                      Date:{" "}
                      {data?.poCreatedAt
                        ? formatDateToWords(data?.poCreatedAt)
                        : ""}
                    </Text>
                  </View>
                ...
                <View style={styles.body}>
                  <View style={styles.supplierSection}>
                    <View style={styles.infoRow}>
                      ...
                      <Text style={styles.value}>{data?.poCreatedByName}</Text>
                    </View>
                  </View>
                  <View style={styles.supplierSection}>
                    <View style={styles.infoRow}>
                    ...
                    <View style={styles.infoRow}>
                      ...
                      <Text style={styles.value}>{data?.poStatus}</Text>
                    </View>
                  </View>
                </View>
